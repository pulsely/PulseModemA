...
+ (void)setGlobalThemeUsingPrimaryColor:(UIColor *)primaryColor
    ...
    [[self class] customizeProgressViewWithPrimaryColor:primaryColor andSecondaryColor: UIColorFromRGB( 0xfbcf21 )];
    ...
    [[self class] customizeSwitchWithPrimaryColor:primaryColor andSecondaryColor: UIColorFromRGB( 0x4b529f )];
